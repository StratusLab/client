...
class Undeploy(unittest.TestCase):
    ...
    def testUndeploy(self):
        undeploy = '%s "undeploy(%s,%s)" 2> /dev/null' % (Undeploy.CLAUDIA_EXEC, Undeploy.CLAUDIA_CUSTOMER, Undeploy.CLAUDIA_SERVICENAME)

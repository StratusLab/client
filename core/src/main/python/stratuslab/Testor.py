...
""" % remote_test_file
    ...
    def _registerInvalidImageInMarketplace(self):
        # manifest with invalid SHA1
        image_id = 'JcqGhHxmTRAEpHMmRF-xhSTM3TO'
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:slreq="http://mp.stratuslab.eu/slreq#" xmlns:slterms="http://mp.stratuslab.eu/slterms#" xml:base="http://mp.stratuslab.eu/">
    ...
    <rdf:Description rdf:about="#JcqGhHxmTRAEpHMmRF-xhSTM3TO">

        <dcterms:identifier>JcqGhHxmTRAEpHMmRF-xhSTM3TO</dcterms:identifier>

        <slreq:bytes>4</slreq:bytes>

        <slreq:checksum rdf:parseType="Resource">
            <slreq:algorithm>MD5</slreq:algorithm>
            <slreq:value>5c9597f3c8245907ea71a89d9d39d08e</slreq:value>
        </slreq:checksum>
        <slreq:checksum rdf:parseType="Resource">
            <slreq:algorithm>SHA-1</slreq:algorithm>
            <slreq:value>972a1a11f19934401291cc99117ec614933374ce</slreq:value>
        </slreq:checksum>
        <slreq:checksum rdf:parseType="Resource">
            <slreq:algorithm>SHA-256</slreq:algorithm>
            <slreq:value>17e682f060b5f8e47ea04c5c4855908b0a5ad612022260fe50e11ecb0cc0ab76</slreq:value>
        </slreq:checksum>
        <slreq:checksum rdf:parseType="Resource">
            <slreq:algorithm>SHA-512</slreq:algorithm>
            <slreq:value>77e52614a141cef19a76de6193e9c845b8cffffecf4973653e5d7a5d121450fab6142890e0f794715722ba4257ee28cb0f4e3966f18e11c9e62fa6babf0a748f</slreq:value>
        </slreq:checksum>

        <slreq:endorsement rdf:parseType="Resource"><created xmlns="http://purl.org/dc/terms/">2012-01-30T08:40:07Z</created><endorser xmlns="http://mp.stratuslab.eu/slreq#" rdf:parseType="Resource"><email>Konstantin.Skaburskas@cern.ch</email><subject>CN=Konstantin Skaburskas,CN=658461,CN=kskaburs,OU=Users,OU=Organic Units,DC=cern,DC=ch</subject><issuer>CN=CERN Trusted Certification Authority,DC=cern,DC=ch</issuer></endorser></slreq:endorsement>

        <dcterms:type>base</dcterms:type>
        <slterms:kind>machine</slterms:kind>

        <slterms:os>fedora</slterms:os>
        <slterms:os-version>14</slterms:os-version>
        <slterms:os-arch>i386</slterms:os-arch>
        <slterms:version>0.1</slterms:version>
        <dcterms:compression>gz</dcterms:compression>
        

        <dcterms:format>raw</dcterms:format>

        <dcterms:creator>Konstantin Skaburskas</dcterms:creator>

        <dcterms:created>2012-01-30T08:33:23Z</dcterms:created>
        <dcterms:valid>2012-07-26T08:33:23Z</dcterms:valid>

        <dcterms:description>dummy manifest to test sha1 mismatch.</dcterms:description>

        <slterms:hypervisor>kvm</slterms:hypervisor>

        <dcterms:publisher>StratusLab</dcterms:publisher>
        <slterms:location>http://appliances.stratuslab.eu/images/base/ttylinux-9.7-i486-base/1.4/ttylinux-9.7-i486-base-1.4.qcow.gz</slterms:location> 

    </rdf:Description>
<Signature xmlns="http://www.w3.org/2000/09/xmldsig#"><SignedInfo><CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments"/><SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1"/><Reference URI=""><Transforms><Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"/></Transforms><DigestMethod Algorithm="http://www.w3.org/2000/09/xmldsig#sha1"/><DigestValue>rhhl9MYFcJPhdd2chKXgbVM/rGc=</DigestValue></Reference></SignedInfo><SignatureValue></SignatureValue><KeyInfo><X509Data><X509Certificate></X509Certificate></X509Data></KeyInfo></Signature></rdf:RDF>
"""
